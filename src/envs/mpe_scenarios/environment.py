...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        self.world = world
        self.episode_limit = world.episode_limit
    ...
    def step(self, actions):
        ...
        obs_n, reward_n, done_n, info_n = self._step(actions)
    ...
    def reset(self):
        """Reset the environment. Required after each full (or truncated) episode.
    ...
    def get_obs_agent(self, agent_id):
        ...
        """
        agent_obs = self._get_obs(self.agents[agent_id])
        return agent_obs
    ...
    def get_obs(self):
        ...
        """
        agent_obs = [self.get_obs_agent(i) for i in range(self.n)]
        return agent_obs

    def get_obs_size(self):
        """ Returns the size of the observation """
        agent_obs_sizes = [len(self.get_obs_agent(i)) for i in range(self.n)]
        agent_obs_size_set = set(agent_obs_sizes)
        assert len(agent_obs_size_set) == 1
        return agent_obs_sizes[0]
    ...
    def get_state_size(self):
        ...
        return self.get_obs_size() * self.n
